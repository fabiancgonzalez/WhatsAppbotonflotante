...
document.addEventListener("DOMContentLoaded", function () {
    ...
    menu.innerHTML = `
        ...
        <a href="https://wa.me/93513729188?text=Hola,%20quiero%20solicitar%20una%20cotización" class="menu-item">
            <div class="menu-icon">
        ...
        <a href="https://wa.me/93513729188?text=Hola,%20quiero%20ser%20proveedor" class="menu-item">
            <div class="menu-icon">
        ...
        <a href="https://wa.me/93513729188?text=Hola,%20quiero%20trabajar%20con%20ustedes" class="menu-item">
            <div class="menu-icon">
                <i class="fas fa-briefcase"></i>
            </div>
            <div class="menu-text">
                <strong>Oportunidades Laborales</strong>
                <span>Forma parte de nuestro equipo de ventas</span>
            </div>
            <div class="menu-arrow">→</div>
        </a>
        
        <!-- Opción 4: Otras Consultas -->
        <a href="https://wa.me/93513729188?text=Hola,%20tengo%20otra%20consulta" class="menu-item">
            <div class="menu-icon">
